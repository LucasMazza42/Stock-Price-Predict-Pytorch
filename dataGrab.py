...
def get_stock_prices(symbol, api_key, start_date, end_date, file_path):
    ...
    if response.status_code == 200:
        ...
        print("Failed to retrieve stock, please check the the symbol and internet connection.")
        return None
...
'''
def getDataList(api_key, symbol, file_path, trainingDataCurrent, start_date, end_date): 
